...
async function main() {
  ...
  const mobileInstallUiScript = [
    ...
    '      padding: 8px 10px;',
    '      border-radius: 999px;',
    '      border: 1px solid rgba(102, 182, 255, .55);',
    '      background: rgba(10, 20, 36, .95);',
