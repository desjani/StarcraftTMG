...
async function main() {
  ...
  const mobileInstallUiScript = [
    ...
    '      const installStateKey = \'adjutant-mobile-installed\';',
    '      const isStandalone = window.matchMedia(\'(display-mode: standalone)\').matches',
    '        || window.navigator.standalone === true',
    '        || document.referrer.startsWith(\'android-app://\');',
    '      if (isStandalone) {',
    '        try { window.localStorage.setItem(installStateKey, \'1\'); } catch {}',
    '        return;',
    '      }',
    '      let installPreviouslyDetected = false;',
    '      try {',
    '        installPreviouslyDetected = window.localStorage.getItem(installStateKey) === \'1\';',
    '      } catch {}',
    '      if (installPreviouslyDetected) return;',
    '',
